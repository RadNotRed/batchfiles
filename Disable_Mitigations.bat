...
echo Disabled Spectre ^&^ Meltdown 
timeout 1 > nul

:: NTFS Mitigations 
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager" /v "ProtectionMode" /t REG_DWORD /d "0" /f >nul 2>&1
echo Disabled NTFS Mitigations 
timeout 1 > nul
...
echo Disabled Structured Exception Handling Overwrite Protection (SEHOP)
timeout 1 > nul

:: Data Excecution Prevention (DEP)
bcdedit /set nx AlwaysOff >nul 2>&1
echo Disabled Data Excecution Prevention (DEP)
timeout 1 > nul
cls
